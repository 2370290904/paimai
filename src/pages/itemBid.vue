<template>
  ...
  <div class="itemBid">
    ...
    <div class="itemBid_con">
      <!-- 当前页面位置 -->
      <present :titles="['拍卖','发标','分类选择','发标','填写信息']"></present>
      <div class="w1200">
        <p v-if="index==0" class="itemBid_title">单品发标信息</p>
        <p v-else class="itemBid_title">组合品发标信息</p>
        <el-form style="margin-top:30px;" ref="form" :model="form" label-width="125px">
          <el-form-item label="标题">
            <el-input placeholder="一句话概括您要什么？比如：苹果笔记本" v-model="form.name"></el-input>
          </el-form-item>
          <el-form-item label="需求描述">
            <el-input placeholder="请描述你想要的商品..." type="textarea" v-model="form.desc"></el-input>
          </el-form-item>
          ...
          <el-form-item label="起拍单价">
            <el-input placeholder="例：￥8000.00" v-model="form.name"></el-input>
          </el-form-item>
          <el-form-item label="保底单价" v-show="base">
            <el-input placeholder="例：￥6000.00" v-model="form.name"></el-input>
          </el-form-item>
